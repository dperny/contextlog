...
// Re-export logrus.Fields so that users don't have to import logrus to use
// WithFields (a common use case)
...
func WithFields(ctx context.Context, fields Fields) context.Context {
	...
	return WithLogger(ctx, logger.(*logrus.Entry).WithFields(logrus.Fields(fields)))
}
